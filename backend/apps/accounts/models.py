...
class User(AbstractUser):
    username = models.CharField('Имя пользователя', max_length=12, unique=True)
    email = models.EmailField('Электронная почта', max_length=30, unique=True)
    sex = models.CharField('ВЫбор пола ', choices=MALE_CHOICES, default='None')
    age = models.DateTimeField('Дата рождения', null=True, blank=True)
    ...
    favorite_song = models.ManyToManyField(Music, verbose_name='Избранное',
